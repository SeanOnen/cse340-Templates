...
ADD CONSTRAINT fk_classifcation FOREIGN KEY (classification_id) REFERENCES public.classification (classification_id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE NO ACTION;
...
-- Update the GM Hummer description using REPLACE
